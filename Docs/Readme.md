...
Usage: Gerber2pdf [-silentexit] [-nowarnings] [-CMYK] ...
       ...
       [-strokes2fills] [-page_size=extents|A3|A4|letter|A2|A1|A0|X200] ...
...
The -page_size option takes global effect and can have one of 8 values:
  ...
  Note: Kazzz-S added the last four; "X200" is the largest 200"x200".

The -orientation and -scale_to_fit options only take effect
on standard paper sizes (i.e. A3, A4, letter, A2, A1, A0 and X200).
```
